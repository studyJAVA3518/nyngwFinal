	...
	전자 문서를 수정할 수 있습니다.
	 ...
	 <div>
		...
		<table class="table table-bordered tableGray">
			<tr>
				<th>문서구분번호</th>
				<td>${document.doc_code_number }<input type="hidden" value="${document.doc_code_number}" name="doc_code_number" readonly="readonly"></td>
				<th>문서번호</th><td>${document.doc_number }<input type="hidden" value="${document.doc_number}" name="doc_number" readonly="readonly"></td>
			</tr>
			<tr>
				<th>문서명</th><td><input type="text" value="${document.doc_name }" name="doc_name" class="form-control"></td>
		...
		<jsp:include page="/WEB-INF/views/common/daumOpenEditor/editor.jsp" flush="false"/>
			...
			<div class="textCenter">
				...
				<button type="button" class="btn btn-default"><a href="/documentManagement/documentManager/edocumentSelect?page=${page }">취소</a></button>
			</div>
		</form>
	</div> 
