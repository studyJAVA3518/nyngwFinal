...
<!-- 			</colgroup> -->
			...
			<tbody>
				...
				<tr>
					<th>파일</th>
					<td colspan="3"><input type="file" name="doc_file_name" onchange="javascript:file_change(this.value);">
						<div id="files">
							<ul id="fileList">
								<li id="intro">
									<i class="fa fa-file" aria-hidden="true"></i>
									<p class="file-info">등록할 파일을 드래그해주세요.</p>
								</li>
							</ul>
						</div>
						<div id="wastebasket">업로드 취소할 파일을 옮겨주세요</div>
