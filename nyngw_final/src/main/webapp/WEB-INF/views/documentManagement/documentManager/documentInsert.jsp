		...
		<table class="table table-bordered tableGray">
			...
			<tbody>
				...
				<tr>
					<th>보존기간</th>
					<td colspan="3">
						<input type="text" id="doc_lifetime" name="doc_lifetime" class="form-control docInputSelect inputTypeDate">
					</td>
				</tr>
				<tr>
					<th>작성자</th>
					<td colspan="3">
						<input type="text" id="doc_mem_number" name="doc_mem_number" value="${mem.mem_name }" readonly="readonly" class="form-control docInputSelect">
					</td>
				</tr>
				<tr>
					<th>문서명</th>
