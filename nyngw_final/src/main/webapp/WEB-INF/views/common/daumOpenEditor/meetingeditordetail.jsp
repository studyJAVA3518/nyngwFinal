					...
					<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
						...
						<div class="tx-menu-footer">
							<img class="tx-menu-confirm"
								 src="<c:url value="/resources/daumOpenEditor/images/icon/editor/btn_confirm.gif?rv=1.0.1"/>" alt=""/>
							<img class="tx-menu-cancel" hspace="3"
								 src="<c:url value="/resources/daumOpenEditor/images/icon/editor/btn_cancel.gif?rv=1.0.1"/>" alt=""/>
						</div>
					</div>
				</li>
				<li class="tx-list">
		...
		<div id="tx_canvas" class="tx-canvas">
			...
			<div class="tx-source-deco">
				<div id="tx_canvas_source_holder" class="tx-holder">
					<textarea id="tx_canvas_source" rows="30" cols="30" >${meeting.mt_content }</textarea>
				</div>
			</div>
			<div id="tx_canvas_text_holder" class="tx-holder" >
				<textarea id="tx_canvas_text" rows="30" cols="30" >${meeting.mt_content }</textarea>
			</div>
		</div>
		<!-- 높이조절 Start -->
...
<script type="text/javascript">
	var config = {
		...
		txIconPath: "<c:url value="/resources/daumOpenEditor/images/icon/editor/"/>", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "<c:url value="/resources/daumOpenEditor/images/deco/contents/"/>", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
			styles: {
				color: "#123456", /* 기본 글자색 */
